...
const fuelStationLogin = async (email, password) => {
  const response = await axios.post(API_URL + "fuel/login", {
    email,
    password,
  });
  console.log(response);
...
const fuelStationRegister = async (
  name,
  owner,
  email,
  password,
  ...
  const response = await axios.post(API_URL + "fuel/register", {
    name,
    owner,
    email,
    password,
...
const fuelInventoryUpdate = async (quantity, stationId) => {
  const response = await axios.put(API_URL + "fuel/updateFuel", {
    quantity,
    stationId,
  });
  console.log(response);
...
const getFuelStation = async () => {
  const response = await axios.get(API_URL + "fuel/getStations");
  return response;
};

const getFuelStationByID = async (id) => {
  const response = await axios.get(API_URL + `fuel/${id}`);
  return response;
};
...
const cancelOrder = async (id) => {
  const response = await axios.put(API_URL + `order/cancel`, {
    id,
  });
  return response;
};
...
const acceptOrder = async (id) => {
  const response = await axios.put(API_URL + `order/accept`, {
    id,
  });
  return response;
};
...
const deliveryOrder = async (id) => {
  const response = await axios.put(API_URL + `order/deliever`, {
    id,
  });
  return response;
};
...
const getOrders = async (id) => {
  const response = await axios.get(
    API_URL + `order/getOrderByFuelStationId/${id}`
  );
  return response;
};
const getUserOrders = async (id) => {
  const response = await axios.get(API_URL + `order/getOrderByUserId/${id}`);
  return response;
};
const updateProfilePassword = async (userId, password, newPassword) => {
  const response = await axios.put(API_URL + `user/changePassword`, {
    userId,
    password,
    newPassword,
  });
...
const updateSellerProfilePassword = async (
  stationId,
  password,
  newPassword
) => {
  const response = await axios.put(API_URL + `fuel/changePassword`, {
    stationId,
    password,
    newPassword,
  });
